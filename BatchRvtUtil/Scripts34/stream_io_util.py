...
#
#
# IronPython 3.4 port (Phase 2a). Only difference vs 2.7: `except IOException, e:` → `as e:`.
#
...
def UsingStream(stream, action):
    ...
    try:
        ...
        def safeCloseAndDispose():
            ...
            stream.Dispose()
            return
        # NOTE: WithIgnoredIOException because Close() can throw IOException ("Pipe is broken").
