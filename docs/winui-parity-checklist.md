...
| B4 | Load-failure feedback is explicit and actionable | Implemented | WinForms now surfaces load failures explicitly via error dialog: [src/apps/Batch.App.Gui/BatchRvtGuiForm.cs](src/apps/Batch.App.Gui/BatchRvtGuiForm.cs#L399), [src/apps/Batch.App.Gui/BatchRvtGuiForm.cs](src/apps/Batch.App.Gui/BatchRvtGuiForm.cs#L411). WinUI continues to emit status and output errors: [src/apps/Batch.App.Ui/MainWindow.xaml.cs](src/apps/Batch.App.Ui/MainWindow.xaml.cs#L520), [src/apps/Batch.App.Ui/MainWindow.xaml.cs](src/apps/Batch.App.Ui/MainWindow.xaml.cs#L522). | Keep failure text aligned through shared settings workflow error messages. |
...
| V2 | Edit settings content before save | Implemented | WinUI now exposes typed primary workflow editors (task script, Revit list, processing mode) plus explicit sync-to-JSON action and save/start integration: [src/apps/Batch.App.Ui/MainWindow.xaml.cs](src/apps/Batch.App.Ui/MainWindow.xaml.cs#L234), [src/apps/Batch.App.Ui/MainWindow.xaml.cs](src/apps/Batch.App.Ui/MainWindow.xaml.cs#L475), [src/apps/Batch.App.Ui/MainWindow.xaml.cs](src/apps/Batch.App.Ui/MainWindow.xaml.cs#L675), [src/apps/Batch.App.Ui/MainWindow.xaml.cs](src/apps/Batch.App.Ui/MainWindow.xaml.cs#L724). WinForms typed baseline remains in [src/apps/Batch.App.Gui/BatchRvtGuiForm.cs](src/apps/Batch.App.Gui/BatchRvtGuiForm.cs#L98) and [src/apps/Batch.App.Gui/BatchRvtGuiForm.cs](src/apps/Batch.App.Gui/BatchRvtGuiForm.cs#L277). | Capture one interactive run using [docs/winui-parity-interactive-runbook.md](docs/winui-parity-interactive-runbook.md) before sign-off. |
...
| P2 | Primary workflow gate executed and recorded | Partial | Execution evidence captured in [docs/winui-parity-gate-evidence.md](docs/winui-parity-gate-evidence.md), including passes for shared workflow and filtering scenarios plus noted environment constraints. Interactive execution process and capture format are now defined in [docs/winui-parity-interactive-runbook.md](docs/winui-parity-interactive-runbook.md) and [docs/winui-parity-interactive-capture-template.md](docs/winui-parity-interactive-capture-template.md). | Execute the runbook in a Revit-capable policy-permitted environment and append completed template evidence. |
